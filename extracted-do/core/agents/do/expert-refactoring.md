...
skills: {{slot:BRAND}}-foundation-claude, {{slot:BRAND}}-foundation-core, {{slot:BRAND}}-foundation-quality, {{slot:BRAND}}-tool-ast-grep, {{slot:BRAND}}-workflow-testing, {{slot:BRAND}}-workflow-ddd
---
...
Required Skill: {{slot:BRAND}}-tool-ast-grep
