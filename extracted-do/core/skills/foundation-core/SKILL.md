---
name: {{slot:BRAND}}-foundation-core
description: >
  ...
  Do NOT use for context and token management (use {{slot:BRAND}}-foundation-context instead)
  or strategic analysis (use {{slot:BRAND}}-foundation-philosopher instead).
license: Apache-2.0
...
Skills: {{slot:BRAND}}-cc-claude-md for CLAUDE.md with foundation patterns, {{slot:BRAND}}-cc-configuration for config with TRUST 5, {{slot:BRAND}}-cc-memory for token optimization, {{slot:BRAND}}-context7-integration for MCP integration.
