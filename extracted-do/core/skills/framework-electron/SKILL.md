---
name: {{slot:BRAND}}-framework-electron
description: >
...
metadata:
  ...
  related-skills: "{{slot:BRAND}}-lang-typescript, {{slot:BRAND}}-domain-frontend, {{slot:BRAND}}-lang-javascript"
---
...
- {{slot:BRAND}}-lang-typescript - TypeScript patterns for type-safe Electron development
- {{slot:BRAND}}-domain-frontend - React, Vue, or Svelte renderer development
- {{slot:BRAND}}-lang-javascript - Node.js patterns for main process
- {{slot:BRAND}}-domain-backend - Backend API integration
- {{slot:BRAND}}-workflow-testing - Testing strategies for desktop apps
