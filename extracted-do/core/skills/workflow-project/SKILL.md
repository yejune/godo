---
name: {{slot:BRAND}}-workflow-project
description: >
...
metadata:
  ...
  aliases: "{{slot:BRAND}}-workflow-project"
...
- {{slot:BRAND}}-foundation-core: Core execution patterns and SPEC-driven development workflows
- {{slot:BRAND}}-foundation-claude: Claude Code integration and configuration
