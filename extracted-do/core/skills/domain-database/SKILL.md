---
name: {{slot:BRAND}}-domain-database
description: >
  ...
  (use {{slot:BRAND}}-domain-backend instead).
license: Apache-2.0
...
- {{slot:BRAND}}-domain-backend - API integration and business logic
- {{slot:BRAND}}-foundation-core - Database migration and schema management
- {{slot:BRAND}}-workflow-project - Database project setup and configuration
- {{slot:BRAND}}-platform-supabase - Supabase database integration patterns
- {{slot:BRAND}}-platform-neon - Neon database integration patterns
- {{slot:BRAND}}-platform-firestore - Firestore database integration patterns
