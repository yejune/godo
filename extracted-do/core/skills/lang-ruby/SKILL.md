...
- {{slot:BRAND}}-domain-backend for REST API and web application architecture
- {{slot:BRAND}}-domain-database for SQL patterns and ActiveRecord optimization
