...
description: >
  ...
  Do NOT use for implementation (use {{slot:BRAND}}-workflow-ddd instead)
...
metadata:
  ...
  updated: "2026-01-08"
  modularized: "true"
  tags: "workflow, spec, ears, requirements, {{slot:BRAND}}-adk, planning"
...
- {{slot:BRAND}}-workflow-testing skill reference for test patterns
...
- {{slot:BRAND}}-foundation-core: SPEC-First DDD methodology and TRUST 5 framework
- {{slot:BRAND}}-workflow-testing: DDD implementation and test automation
- {{slot:BRAND}}-workflow-project: Project initialization and configuration
- {{slot:BRAND}}-workflow-worktree: Git Worktree management for parallel development
