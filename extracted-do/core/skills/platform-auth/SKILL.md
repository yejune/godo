...
metadata:
  ...
  related-skills: "{{slot:BRAND}}-platform-supabase, {{slot:BRAND}}-platform-vercel, {{slot:BRAND}}-lang-typescript, {{slot:BRAND}}-domain-backend, {{slot:BRAND}}-expert-security"
...
- {{slot:BRAND}}-platform-supabase: Database with auth integration
- {{slot:BRAND}}-platform-vercel: Deployment with edge authentication
- {{slot:BRAND}}-lang-typescript: TypeScript patterns for auth SDKs
- {{slot:BRAND}}-domain-backend: Backend architecture with authentication
- {{slot:BRAND}}-domain-frontend: React/Next.js frontend integration
- {{slot:BRAND}}-expert-security: Security audit and threat modeling
