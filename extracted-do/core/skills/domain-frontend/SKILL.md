---
name: {{slot:BRAND}}-domain-frontend
description: >
...
- {{slot:BRAND}}-domain-backend - Full-stack development
- {{slot:BRAND}}-library-shadcn - Component library integration
- {{slot:BRAND}}-domain-uiux - UI/UX design principles
- {{slot:BRAND}}-lang-typescript - TypeScript patterns
- {{slot:BRAND}}-workflow-testing - Frontend testing
