...
class AlfredAgentCoordinator:
 ...
 def __init__(self):
 self.debug_agent = "{{slot:BRAND}}-essentials-debug"
 self.perf_agent = "{{slot:BRAND}}-essentials-perf"
 self.review_agent = "{{slot:BRAND}}-essentials-review"
 self.trust_agent = "{{slot:BRAND}}-foundation-trust"
