---
name: {{slot:BRAND}}-lang-typescript
description: >
...
- {{slot:BRAND}}-domain-frontend for UI components and styling patterns
- {{slot:BRAND}}-domain-backend for API design and database integration
- {{slot:BRAND}}-library-shadcn for component library integration
- {{slot:BRAND}}-workflow-testing for testing strategies and patterns
- {{slot:BRAND}}-foundation-quality for code quality standards
- {{slot:BRAND}}-essentials-debug for debugging TypeScript applications
