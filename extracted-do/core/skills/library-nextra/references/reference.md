# {{slot:BRAND}}-library-nextra Reference
...
- `{{slot:BRAND}}-docs-generation`: Automated documentation generation
- `{{slot:BRAND}}-workflow-docs`: Documentation workflow management
- `{{slot:BRAND}}-domain-frontend`: Frontend development patterns
- `{{slot:BRAND}}-library-mermaid`: Diagram integration
