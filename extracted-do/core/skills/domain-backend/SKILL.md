---
name: {{slot:BRAND}}-domain-backend
description: >
  ...
  (use {{slot:BRAND}}-domain-database instead) or frontend implementation
  (use {{slot:BRAND}}-domain-frontend instead).
license: Apache-2.0
...
- {{slot:BRAND}}-domain-frontend - Full-stack development integration
- {{slot:BRAND}}-domain-database - Advanced database patterns
- {{slot:BRAND}}-foundation-core - MCP server development patterns for backend services
- {{slot:BRAND}}-quality-security - Security validation and compliance
- {{slot:BRAND}}-foundation-core - Core architectural principles
