...
metadata:
  ...
  related-skills: "{{slot:BRAND}}-domain-frontend, {{slot:BRAND}}-docs-generation"
...
- {{slot:BRAND}}-domain-frontend: React/Vue SVG component integration
- {{slot:BRAND}}-docs-generation: SVG diagram generation for documentation
- {{slot:BRAND}}-domain-uiux: Icon systems and design system integration
