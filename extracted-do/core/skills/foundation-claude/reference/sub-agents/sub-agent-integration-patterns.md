...
model: sonnet
skills: {{slot:BRAND}}-core-workflow, {{slot:BRAND}}-project-manager, {{slot:BRAND}}-foundation-quality
---
...
model: sonnet
skills: {{slot:BRAND}}-domain-backend, {{slot:BRAND}}-domain-frontend, {{slot:BRAND}}-domain-database, {{slot:BRAND}}-devops-expert
---
