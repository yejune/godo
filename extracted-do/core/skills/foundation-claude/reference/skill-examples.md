...
```yaml
---
name: {{slot:BRAND}}-docs-api-generator
...
- [`{{slot:BRAND}}-docs-toolkit`](../{{slot:BRAND}}-docs-toolkit/SKILL.md) - General documentation patterns
- [`{{slot:BRAND}}-domain-backend`](../{{slot:BRAND}}-domain-backend/SKILL.md) - Backend API expertise
- [`{{slot:BRAND}}-context7-integration`](../{{slot:BRAND}}-context7-integration/SKILL.md) - Latest framework docs
...
```yaml
---
name: {{slot:BRAND}}-code-comment-analyzer
...
- [`{{slot:BRAND}}-lang-python`](../{{slot:BRAND}}-lang-python/SKILL.md) - Python-specific patterns
- [`{{slot:BRAND}}-code-quality`](../{{slot:BRAND}}-code-quality/SKILL.md) - General code quality assessment
- [`{{slot:BRAND}}-cc-claude-md`](../{{slot:BRAND}}-cc-claude-md/SKILL.md) - Documentation generation
...
```yaml
---
name: {{slot:BRAND}}-python-testing-expert
...
- [`{{slot:BRAND}}-lang-python`](../{{slot:BRAND}}-lang-python/SKILL.md) - Python language patterns
- [`{{slot:BRAND}}-workflow-ddd`](../{{slot:BRAND}}-workflow-ddd/SKILL.md) - DDD methodology
- [`{{slot:BRAND}}-quality-gate`](../{{slot:BRAND}}-quality-gate/SKILL.md) - Quality validation
...
```yaml
---
name: {{slot:BRAND}}-modern-javascript-patterns
...
- [`{{slot:BRAND}}-domain-frontend`](../{{slot:BRAND}}-domain-frontend/SKILL.md) - Frontend development patterns
- [`{{slot:BRAND}}-context7-integration`](../{{slot:BRAND}}-context7-integration/SKILL.md) - Latest framework docs
- [`{{slot:BRAND}}-web-performance`](../{{slot:BRAND}}-web-performance/SKILL.md) - Performance optimization
...
```yaml
---
name: {{slot:BRAND}}-security-analysis-expert
...
- [`{{slot:BRAND}}-cc-security`](../{{slot:BRAND}}-cc-security/SKILL.md) - General security patterns
- [`{{slot:BRAND}}-quality-gate`](../{{slot:BRAND}}-quality-gate/SKILL.md) - Quality validation
- [`{{slot:BRAND}}-domain-backend`](../{{slot:BRAND}}-domain-backend/SKILL.md) - Backend security
...
```yaml
---
name: {{slot:BRAND}}-workflow-automation-expert
...
- [`{{slot:BRAND}}-devops-expert`](../{{slot:BRAND}}-devops-expert/SKILL.md) - DevOps best practices
- [`{{slot:BRAND}}-monitoring-expert`](../{{slot:BRAND}}-monitoring-expert/SKILL.md) - Monitoring strategies
- [`{{slot:BRAND}}-security-expert`](../{{slot:BRAND}}-security-expert/SKILL.md) - Security automation
