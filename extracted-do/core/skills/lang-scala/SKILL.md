...
- {{slot:BRAND}}-lang-java - JVM interoperability, Spring Boot integration
- {{slot:BRAND}}-domain-backend - REST API, GraphQL, microservices patterns
- {{slot:BRAND}}-domain-database - Doobie, Slick, database patterns
- {{slot:BRAND}}-workflow-testing - ScalaTest, MUnit, property-based testing
