...
metadata:
  ...
  related-skills: "{{slot:BRAND}}-lang-rust, {{slot:BRAND}}-domain-backend"
...
- {{slot:BRAND}}-domain-backend for REST API architecture and microservices
- {{slot:BRAND}}-lang-rust for systems programming companion
- {{slot:BRAND}}-quality-security for security hardening
- {{slot:BRAND}}-essentials-debug for performance profiling
- {{slot:BRAND}}-workflow-ddd for domain-driven development
