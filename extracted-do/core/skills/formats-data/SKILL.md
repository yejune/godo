...
- {{slot:BRAND}}-domain-backend - Backend data serialization and API responses
- {{slot:BRAND}}-domain-database - Database data format optimization
- {{slot:BRAND}}-foundation-core - MCP data serialization and transmission patterns
- {{slot:BRAND}}-workflow-docs - Documentation data formatting
- {{slot:BRAND}}-foundation-context - Context optimization for token budgets
