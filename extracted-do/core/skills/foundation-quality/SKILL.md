---
name: {{slot:BRAND}}-foundation-quality
description: >
  ...
  Do NOT use for writing tests (use {{slot:BRAND}}-workflow-testing instead)
...
metadata:
  ...
  aliases: "{{slot:BRAND}}-foundation-quality"
...
- {{slot:BRAND}}-foundation-core - TRUST 5 framework reference
- {{slot:BRAND}}-workflow-ddd - DDD workflow validation
- {{slot:BRAND}}-security-owasp - Security compliance
- {{slot:BRAND}}-context7-integration - Context7 best practices
- {{slot:BRAND}}-performance-optimization - Performance analysis
