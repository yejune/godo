...
This directory contains the detailed implementation modules for the {{slot:BRAND}}-formats-data skill, following Claude Code's progressive disclosure pattern.
