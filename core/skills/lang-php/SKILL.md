...
- {{slot:BRAND}}-domain-backend for REST API and microservices architecture
- {{slot:BRAND}}-domain-database for SQL patterns and ORM optimization
- {{slot:BRAND}}-workflow-testing for DDD and testing strategies
- {{slot:BRAND}}-platform-deploy for Docker and deployment patterns
- {{slot:BRAND}}-essentials-debug for AI-powered debugging
- {{slot:BRAND}}-foundation-quality for TRUST 5 quality principles
