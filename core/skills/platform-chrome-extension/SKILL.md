---
name: {{slot:BRAND}}-platform-chrome-extension
description: >
...
metadata:
  ...
  related-skills: "{{slot:BRAND}}-lang-typescript, {{slot:BRAND}}-lang-javascript, {{slot:BRAND}}-domain-frontend"
...
- {{slot:BRAND}}-lang-typescript for TypeScript patterns in extension development
- {{slot:BRAND}}-lang-javascript for JavaScript patterns and ES module usage
- {{slot:BRAND}}-domain-frontend for React or framework-based popup and side panel UI
- {{slot:BRAND}}-domain-backend for server-side API integration
- {{slot:BRAND}}-workflow-testing for extension testing strategies
