...
metadata:
  ...
  related-skills: "{{slot:BRAND}}-domain-uiux, {{slot:BRAND}}-domain-frontend, {{slot:BRAND}}-library-shadcn, {{slot:BRAND}}-lang-typescript, {{slot:BRAND}}-lang-react"
...
- {{slot:BRAND}}-domain-uiux: Design systems and component architecture
- {{slot:BRAND}}-domain-frontend: React implementation patterns
- {{slot:BRAND}}-library-shadcn: shadcn/ui component integration
- {{slot:BRAND}}-lang-typescript: TypeScript for generated components
- {{slot:BRAND}}-lang-react: React best practices
- {{slot:BRAND}}-foundation-core: SPEC-driven development workflows
