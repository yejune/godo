---
name: {{slot:BRAND}}-library-mermaid
description: >
...
To invoke this skill, use the standard skill invocation pattern with the skill name {{slot:BRAND}}-library-mermaid.
...
Skills that complement this skill include {{slot:BRAND}}-docs-generation for comprehensive documentation generation, {{slot:BRAND}}-workflow-docs for diagram validation and documentation workflows, and {{slot:BRAND}}-library-nextra for architecture documentation sites.
