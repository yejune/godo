---
name: {{slot:BRAND}}-lang-javascript
description: >
...
- {{slot:BRAND}}-lang-typescript for TypeScript integration and type checking with JSDoc
- {{slot:BRAND}}-domain-backend for API design and microservices architecture
- {{slot:BRAND}}-domain-database for database integration and ORM patterns
- {{slot:BRAND}}-workflow-testing for DDD workflows and testing strategies
- {{slot:BRAND}}-foundation-quality for code quality standards
- {{slot:BRAND}}-essentials-debug for debugging JavaScript applications
