---
name: {{slot:BRAND}}-docs-generation
description: >
...
Reference Skill("{{slot:BRAND}}-library-nextra") for comprehensive Nextra patterns.
...
Skills:
- {{slot:BRAND}}-library-nextra - Comprehensive Nextra documentation framework patterns
- {{slot:BRAND}}-lang-python - Python docstring conventions and typing
- {{slot:BRAND}}-lang-typescript - TypeScript/JSDoc documentation patterns
- {{slot:BRAND}}-domain-backend - API documentation for backend services
- {{slot:BRAND}}-workflow-project - Project documentation integration
...
Commands:
- /{{slot:BRAND_CMD}}:3-sync - Documentation synchronization with code changes
