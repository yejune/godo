...
Complete API reference and technical documentation for the {{slot:BRAND}}-foundation-quality skill.
...
class QualityConfig:
 ...
 output_directory: str = ".{{slot:BRAND_DIR}}/reports/quality"
...
This comprehensive reference documentation provides complete API coverage for the {{slot:BRAND}}-foundation-quality skill, including all classes, methods, configuration options, and integration patterns needed for enterprise code quality management.
