...
- {{slot:BRAND}}-lang-python for Python and R interoperability with reticulate
- {{slot:BRAND}}-domain-database for SQL patterns and database optimization
