---
name: {{slot:BRAND}}-workflow-templates
description: >
  ...
  Do NOT use for SPEC document creation (use {{slot:BRAND}}-workflow-spec instead)
  or documentation generation (use {{slot:BRAND}}-workflow-project instead).
license: Apache-2.0
...
metadata:
  ...
  aliases: "{{slot:BRAND}}-workflow-templates"
  replaces: "{{slot:BRAND}}-core-code-templates, {{slot:BRAND}}-core-feedback-templates, {{slot:BRAND}}-project-template-optimizer"
...
- Creating GitHub issues with /{{slot:BRAND_CMD}}:9-feedback
...
Integration: Auto-triggered by the /{{slot:BRAND_CMD}}:9-feedback command.
...
Feedback Templates include Bug Report template, Feature Request template, Improvement template, Refactor template, Documentation template, Question template, and integration with /{{slot:BRAND_CMD}}:9-feedback command.
...
- {{slot:BRAND}}-project-config-manager: Configuration management and validation
- {{slot:BRAND}}-cc-configuration: Claude Code settings integration
- {{slot:BRAND}}-foundation-specs: SPEC template generation
- {{slot:BRAND}}-docs-generation: Documentation template scaffolding
- {{slot:BRAND}}-core-workflow: Template-driven workflows

Commands:

- /{{slot:BRAND_CMD}}:0-project: Project initialization with templates
- /{{slot:BRAND_CMD}}:9-feedback: Feedback template selection and issue creation
...
Feedback Submission Workflow: Execute /{{slot:BRAND_CMD}}:9-feedback command, select issue type using Pattern 2, fill template fields, and auto-generate GitHub issue.
...
- v2.0.0 (2025-11-24): Unified {{slot:BRAND}}-core-code-templates, {{slot:BRAND}}-core-feedback-templates, and {{slot:BRAND}}-project-template-optimizer into single skill with 5 core patterns
