---
name: {{slot:BRAND}}-workflow-jit-docs
description: >
...
- Check .{{slot:BRAND_DIR}}/docs/ for project-specific documentation
- Check .{{slot:BRAND_DIR}}/specs/ for requirements and specifications
...
- {{slot:BRAND}}-docs-generation: Documentation generation
- {{slot:BRAND}}-workflow-docs: Documentation validation
- {{slot:BRAND}}-library-nextra: Nextra documentation

Commands:

- /{{slot:BRAND_CMD}}:3-sync: Documentation synchronization
- /{{slot:BRAND_CMD}}:9-feedback: Documentation improvements
