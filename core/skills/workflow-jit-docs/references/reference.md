# {{slot:BRAND}}-workflow-jit-docs Reference
...
- `.{{slot:BRAND_DIR}}/docs/`: Project-specific documentation
- `.{{slot:BRAND_DIR}}/specs/`: Requirements and specifications
...
- `{{slot:BRAND}}-docs-generation`: Generate documentation
- `{{slot:BRAND}}-workflow-docs`: Documentation workflows
- `{{slot:BRAND}}-library-nextra`: Nextra documentation sites
- `{{slot:BRAND}}-foundation-context`: Token budget management
