---
name: {{slot:BRAND}}-library-nextra
description: >
...
metadata:
  ...
  aliases: "{{slot:BRAND}}-library-nextra"
...
Complementary skills include {{slot:BRAND}}-docs-generation for auto-generating docs from code, {{slot:BRAND}}-workflow-docs for validating documentation quality, and {{slot:BRAND}}-cc-claude-md for Markdown formatting.
...
- {{slot:BRAND}}-docs-generation for content generation
- {{slot:BRAND}}-workflow-docs for documentation validation
- {{slot:BRAND}}-library-mermaid for diagram integration
