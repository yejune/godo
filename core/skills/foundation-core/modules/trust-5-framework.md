...
python .{{slot:BRAND_DIR}}/scripts/validate_architecture.py
...
Skills:
- {{slot:BRAND}}-workflow-testing - Test framework setup
- {{slot:BRAND}}-domain-security - Security patterns

Commands:
- /{{slot:BRAND_CMD}}:2-run - Enforces ≥85% coverage requirement
- /{{slot:BRAND_CMD}}:9-feedback - Quality improvement suggestions
