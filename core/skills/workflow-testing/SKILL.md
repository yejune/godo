---
name: {{slot:BRAND}}-workflow-testing
description: >
  ...
  or code refactoring (use {{slot:BRAND}}-workflow-ddd instead).
license: Apache-2.0
...
- {{slot:BRAND}}-domain-backend: Backend development workflows and API testing patterns
- {{slot:BRAND}}-domain-frontend: Frontend development workflows and UI testing strategies
- {{slot:BRAND}}-foundation-core: Core SPEC system and workflow management integration
- {{slot:BRAND}}-platform-supabase: Supabase-specific testing patterns and database testing
- {{slot:BRAND}}-platform-vercel: Vercel deployment testing and edge function validation
- {{slot:BRAND}}-platform-firebase-auth: Firebase authentication testing patterns
- {{slot:BRAND}}-workflow-project: Project management and documentation workflows
