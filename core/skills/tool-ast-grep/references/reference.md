...
sg scan --config .claude/skills/{{slot:BRAND}}-tool-ast-grep/rules/sgconfig.yml
...
- **{{slot:BRAND}}-workflow-testing** - DDD integration, test pattern detection
- **{{slot:BRAND}}-foundation-quality** - TRUST 5 compliance, code quality gates
- **{{slot:BRAND}}-domain-backend** - API pattern detection, security scanning
