# {{slot:BRAND}}-foundation-claude Reference
...
- `{{slot:BRAND}}-foundation-context`: Token budget and session management
- `{{slot:BRAND}}-workflow-project`: Project initialization and configuration
- `{{slot:BRAND}}-docs-generation`: Documentation automation
