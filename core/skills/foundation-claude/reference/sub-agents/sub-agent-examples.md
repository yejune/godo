...
---
name: code-backend
description: Use PROACTIVELY for backend architecture, API design, server implementation, database integration, or microservices architecture. Called from /{{slot:BRAND_CMD}}:1-plan architecture design and task delegation workflows.
...
model: sonnet
skills: {{slot:BRAND}}-domain-backend, {{slot:BRAND}}-essentials-perf, {{slot:BRAND}}-context7-integration, {{slot:BRAND}}-lang-python
---
...
---
name: code-frontend
description: Use PROACTIVELY for frontend UI development, React/Vue/Angular components, responsive design, user experience optimization, or web application architecture. Called from /{{slot:BRAND_CMD}}:2-run implementation and task delegation workflows.
tools: Read, Write, Edit, Grep, Glob, MultiEdit, mcp__context7__resolve-library-id, mcp__context7__get-library-docs
model: sonnet
skills: {{slot:BRAND}}-domain-frontend, {{slot:BRAND}}-cc-configuration, {{slot:BRAND}}-context7-integration, {{slot:BRAND}}-ui-ux-expert
---
...
model: haiku
skills: {{slot:BRAND}}-code-quality, {{slot:BRAND}}-cc-configuration, {{slot:BRAND}}-lang-python
---
...
model: sonnet
skills: {{slot:BRAND}}-essentials-debug, {{slot:BRAND}}-core-code-reviewer, {{slot:BRAND}}-context7-integration
---
...
---
name: workflow-ddd
description: Execute ANALYZE-PRESERVE-IMPROVE DDD cycle for implementing features with behavior preservation and comprehensive test coverage. Called from /{{slot:BRAND_CMD}}:2-run SPEC implementation and task delegation workflows.
tools: Read, Write, Edit, Bash, Grep, Glob, MultiEdit, TodoWrite
model: sonnet
skills: {{slot:BRAND}}-lang-python, {{slot:BRAND}}-domain-testing, {{slot:BRAND}}-foundation-quality, {{slot:BRAND}}-core-spec-authoring
---
...
tools: Read, Write, Edit, Grep, Glob, Bash, WebFetch, mcp__context7__resolve-library-id, mcp__context7__get-library-docs
model: sonnet
skills: {{slot:BRAND}}-domain-security, {{slot:BRAND}}-cc-security, {{slot:BRAND}}-foundation-quality, {{slot:BRAND}}-core-workflow
---
