---
name: {{slot:BRAND}}-foundation-claude
description: >
...
metadata:
  ...
  aliases: "{{slot:BRAND}}-foundation-claude"
...
- Load {{slot:BRAND}}-tool-ast-grep skill for complex pattern matching
...
- {{slot:BRAND}}-foundation-claude: This authoring kit
- {{slot:BRAND}}-foundation-core: SPEC system and workflows
- {{slot:BRAND}}-foundation-philosopher: Strategic thinking
