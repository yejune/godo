---
name: {{slot:BRAND}}-platform-database-cloud
description: >
...
metadata:
  ...
  related-skills: "{{slot:BRAND}}-platform-auth, {{slot:BRAND}}-lang-typescript, {{slot:BRAND}}-domain-backend"
...
# {{slot:BRAND}}-platform-database-cloud: Cloud Database Platform Specialist
...
- {{slot:BRAND}}-platform-auth for authentication integration with Supabase Auth or Firebase Auth
- {{slot:BRAND}}-lang-typescript for TypeScript patterns across all platforms
- {{slot:BRAND}}-lang-flutter for Firestore mobile SDK patterns
- {{slot:BRAND}}-domain-backend for backend architecture with database integration
- {{slot:BRAND}}-domain-mobile for mobile-first database patterns
- {{slot:BRAND}}-quality-security for security best practices (RLS policies, Security Rules)
