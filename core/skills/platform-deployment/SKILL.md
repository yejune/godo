---
name: {{slot:BRAND}}-platform-deployment
description: >
...
- {{slot:BRAND}}-domain-backend for backend architecture patterns
- {{slot:BRAND}}-domain-frontend for frontend integration
- {{slot:BRAND}}-lang-typescript for TypeScript best practices
- {{slot:BRAND}}-lang-python for Python deployment (Railway)
- {{slot:BRAND}}-platform-auth for authentication integration
- {{slot:BRAND}}-platform-database for database patterns
