...
memory: project
skills: {{slot:BRAND}}-foundation-claude, {{slot:BRAND}}-foundation-core, {{slot:BRAND}}-domain-backend, {{slot:BRAND}}-domain-database, {{slot:BRAND}}-lang-python, {{slot:BRAND}}-lang-typescript, {{slot:BRAND}}-lang-javascript, {{slot:BRAND}}-lang-go, {{slot:BRAND}}-lang-java, {{slot:BRAND}}-lang-rust, {{slot:BRAND}}-lang-php, {{slot:BRAND}}-lang-csharp, {{slot:BRAND}}-lang-ruby, {{slot:BRAND}}-lang-elixir, {{slot:BRAND}}-lang-scala, {{slot:BRAND}}-golang-pro, {{slot:BRAND}}-golang-testing, {{slot:BRAND}}-rust-engineer, {{slot:BRAND}}-rust-guidelines, {{slot:BRAND}}-rust-perf, {{slot:BRAND}}-platform-supabase, {{slot:BRAND}}-platform-neon, {{slot:BRAND}}-platform-firestore, {{slot:BRAND}}-platform-convex, {{slot:BRAND}}-tool-ast-grep, {{slot:BRAND}}-workflow-tdd, {{slot:BRAND}}-workflow-ddd, {{slot:BRAND}}-workflow-testing
hooks:
  PreToolUse:
    - matcher: "Write|Edit"
      hooks:
...
- {{slot:BRAND}}-foundation-claude – Core execution rules and agent delegation patterns
- {{slot:BRAND}}-lang-python – Python/FastAPI/Django/Flask patterns
- {{slot:BRAND}}-lang-typescript – TypeScript/Node.js/Express/NestJS patterns
- {{slot:BRAND}}-domain-backend – Backend infrastructure, databases, authentication, microservices architecture

Conditional Skills (auto-loaded by MoAI when needed)

- {{slot:BRAND}}-foundation-core – TRUST 5 framework and quality gates
...
Python Frameworks: FastAPI, Flask, Django patterns provided by {{slot:BRAND}}-lang-python

TypeScript Frameworks: Express, Fastify, NestJS, Sails patterns provided by {{slot:BRAND}}-lang-typescript

Go Frameworks: Gin, Beego patterns provided by {{slot:BRAND}}-lang-go

Rust Frameworks: Axum, Rocket patterns provided by {{slot:BRAND}}-lang-rust

Java Frameworks: Spring Boot patterns provided by {{slot:BRAND}}-lang-java

PHP Frameworks: Laravel, Symfony patterns provided by {{slot:BRAND}}-lang-php
...
[HARD] Use {{slot:BRAND}}-domain-backend skill for backend infrastructure patterns
...
1. [HARD] Read SPEC Files: Access `.{{slot:BRAND_DIR}}/specs/SPEC-{ID}/spec.md`
...
Create `.{{slot:BRAND_DIR}}/docs/backend-architecture-{SPEC-ID}.md`:
...
- {{slot:BRAND}}-lang-python – Python/FastAPI/Django/Flask patterns
- {{slot:BRAND}}-lang-typescript – TypeScript/Node.js/Express/NestJS patterns
- {{slot:BRAND}}-domain-backend – Backend infrastructure, databases, authentication, microservices

Conditional Skills (loaded by MoAI when needed):

- {{slot:BRAND}}-foundation-core – MCP server integration patterns
