...
skills: {{slot:BRAND}}-foundation-claude, {{slot:BRAND}}-foundation-core, {{slot:BRAND}}-foundation-quality, {{slot:BRAND}}-workflow-testing, {{slot:BRAND}}-workflow-tdd, {{slot:BRAND}}-workflow-ddd, {{slot:BRAND}}-lang-python, {{slot:BRAND}}-lang-typescript, {{slot:BRAND}}-lang-javascript, {{slot:BRAND}}-lang-go, {{slot:BRAND}}-lang-java, {{slot:BRAND}}-golang-testing, {{slot:BRAND}}-tool-ast-grep
hooks:
  PostToolUse:
    - matcher: "Write|Edit"
      hooks:
...
- {{slot:BRAND}}-lang-python – Python/pytest/unittest testing patterns
- {{slot:BRAND}}-lang-typescript – TypeScript/Jest/Vitest/Playwright testing patterns
- {{slot:BRAND}}-workflow-testing – Testing strategies and comprehensive test patterns
- {{slot:BRAND}}-foundation-quality – Quality gates and TRUST 5 framework

Conditional Skills (auto-loaded by MoAI when needed)
- {{slot:BRAND}}-foundation-core – SPEC integration and workflow patterns
...
Create `.{{slot:BRAND_DIR}}/docs/test-strategy-{SPEC-ID}.md`:
...
- {{slot:BRAND}}-lang-python – Python/pytest/unittest testing patterns
- {{slot:BRAND}}-lang-typescript – TypeScript/Jest/Vitest/Playwright testing patterns
- {{slot:BRAND}}-workflow-testing – Comprehensive testing strategies and patterns
- {{slot:BRAND}}-foundation-quality – Quality gates and TRUST 5 framework

Conditional Skills (loaded by MoAI when needed):
- {{slot:BRAND}}-workflow-testing – Testing patterns and automation workflows
