...
skills: {{slot:BRAND}}-foundation-claude, {{slot:BRAND}}-foundation-core, {{slot:BRAND}}-foundation-quality, {{slot:BRAND}}-workflow-testing, {{slot:BRAND}}-rust-perf, {{slot:BRAND}}-lang-python, {{slot:BRAND}}-lang-typescript, {{slot:BRAND}}-lang-javascript, {{slot:BRAND}}-lang-rust, {{slot:BRAND}}-lang-go
---
...
- {{slot:BRAND}}-lang-python – Python performance profiling and optimization patterns
- {{slot:BRAND}}-lang-typescript – TypeScript/JavaScript performance optimization patterns
- {{slot:BRAND}}-workflow-testing – Testing strategies and performance test patterns
...
Create `.{{slot:BRAND_DIR}}/docs/performance-analysis-{SPEC-ID}.md`:
