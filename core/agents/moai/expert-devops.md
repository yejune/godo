...
skills: {{slot:BRAND}}-foundation-claude, {{slot:BRAND}}-foundation-core, {{slot:BRAND}}-workflow-project, {{slot:BRAND}}-workflow-jit-docs, {{slot:BRAND}}-workflow-templates, {{slot:BRAND}}-platform-vercel, {{slot:BRAND}}-platform-railway, {{slot:BRAND}}-framework-electron
hooks:
  PostToolUse:
    - matcher: "Write|Edit"
      hooks:
...
- {{slot:BRAND}}-workflow-project – Project configuration and deployment workflows
...
- {{slot:BRAND}}-platform-vercel – Vercel edge deployment patterns for Next.js and React applications
...
- {{slot:BRAND}}-platform-railway – Railway container deployment patterns for full-stack applications
...
- {{slot:BRAND}}-foundation-core – TRUST 5 framework for infrastructure compliance
...
1. Read SPEC Files: `.{{slot:BRAND_DIR}}/specs/SPEC-{ID}/spec.md`
...
4. Use Skills: {{slot:BRAND}}-platform-vercel, {{slot:BRAND}}-platform-railway (from YAML frontmatter) provide platform-specific deployment patterns
...
- {{slot:BRAND}}-workflow-project – Project configuration and deployment workflows
- {{slot:BRAND}}-workflow-jit-docs – Documentation generation and synchronization
- {{slot:BRAND}}-platform-vercel – Vercel edge deployment for Next.js/React applications
- {{slot:BRAND}}-platform-railway – Railway container deployment for full-stack applications
