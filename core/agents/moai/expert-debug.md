...
memory: user
skills: {{slot:BRAND}}-foundation-claude, {{slot:BRAND}}-foundation-core, {{slot:BRAND}}-foundation-quality, {{slot:BRAND}}-workflow-testing, {{slot:BRAND}}-workflow-loop, {{slot:BRAND}}-lang-python, {{slot:BRAND}}-lang-typescript, {{slot:BRAND}}-lang-javascript, {{slot:BRAND}}-lang-go, {{slot:BRAND}}-lang-rust, {{slot:BRAND}}-tool-ast-grep
hooks:
  PostToolUse:
    - matcher: "Write|Edit"
      hooks:
...
3. **Always in English** (regardless of conversation_language):
   - Skill names in invocations: {{slot:BRAND}}-foundation-core, {{slot:BRAND}}-foundation-quality
...
4. **Explicit Skill Invocation**:
   Use explicit syntax: {{slot:BRAND}}-foundation-core, {{slot:BRAND}}-foundation-quality
...
- Invoke: {{slot:BRAND}}-foundation-quality (contains debugging patterns), {{slot:BRAND}}-lang-python
...
- {{slot:BRAND}}-foundation-core: TRUST 5 framework, execution rules, debugging workflows
  WHY: Foundation knowledge enables proper agent delegation

- {{slot:BRAND}}-foundation-quality: Common error patterns, stack trace analysis, resolution procedures
  WHY: Toolkit knowledge accelerates pattern recognition

**Conditional Skill Logic** (auto-loaded by MoAI when needed):

- {{slot:BRAND}}-lang-python: Python debugging patterns (pytest, unittest, debugging tools)
  WHY: Framework-specific knowledge improves diagnosis accuracy
- {{slot:BRAND}}-lang-typescript: TypeScript/JavaScript debugging patterns (Jest, debugging tools)
...
- **Complex Multi-Error Problems**: Recommend running appropriate /{{slot:BRAND_CMD}} command
