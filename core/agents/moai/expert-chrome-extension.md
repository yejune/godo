...
skills: {{slot:BRAND}}-platform-chrome-extension, {{slot:BRAND}}-lang-typescript, {{slot:BRAND}}-lang-javascript, {{slot:BRAND}}-domain-frontend, {{slot:BRAND}}-foundation-quality
---
...
- {{slot:BRAND}}-platform-chrome-extension -- Chrome Extension MV3 patterns, APIs, security, publishing guidelines
- {{slot:BRAND}}-lang-typescript -- TypeScript patterns for type-safe extension development
- {{slot:BRAND}}-lang-javascript -- JavaScript ES2024 patterns for service workers and content scripts
- {{slot:BRAND}}-domain-frontend -- UI component patterns for popup, side panel, and options page

Conditional Skill Logic (auto-loaded by MoAI when needed):

[SOFT] Load {{slot:BRAND}}-foundation-quality when security review or quality validation is required
...
[SOFT] Load {{slot:BRAND}}-foundation-core when TRUST 5 validation is needed
...
- {{slot:BRAND}}-platform-chrome-extension -- Chrome Extension MV3 patterns, chrome.* APIs, security, publishing
- {{slot:BRAND}}-lang-typescript -- TypeScript/JavaScript patterns for type-safe development
- {{slot:BRAND}}-lang-javascript -- JavaScript ES2024 patterns for service workers
- {{slot:BRAND}}-domain-frontend -- UI component patterns for popup, side panel, options
- {{slot:BRAND}}-foundation-quality -- Security patterns, quality validation framework
...
Context Engineering: Load SPEC, manifest.json, and `{{slot:BRAND}}-platform-chrome-extension` Skill first. Fetch Chrome API documentation via Context7 on-demand after extension type detection.
