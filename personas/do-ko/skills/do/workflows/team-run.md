...
- Approved SPEC document at .do/specs/SPEC-XXX/
- workflow.team.enabled: true
- CLAUDE_CODE_EXPERIMENTAL_AGENT_TEAMS=1
- Triggered by: /do run SPEC-XXX --team OR auto-detected complexity >= threshold
...
- Do operates in coordination-only mode during the entire run phase
