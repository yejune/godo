...
description: >
  ...
  Creates product.md, structure.md, and tech.md in .do/project/ directory.
...
Purpose: Generate project documentation from codebase analysis. Creates product.md, structure.md, and tech.md in .do/project/ directory.
...
- Fresh Documentation: When .do/project/ is empty, generate all three files
...
- Write SPEC: Execute /do plan to define feature specifications
...
- Phase 0-2: Do orchestrator (AskUserQuestion for all user interaction)
