...
LOG_FILE="$PROJECT_ROOT/.do/logs/quality-gate.log"
CONFIG_FILE="$PROJECT_ROOT/.do/config/quality-config.yaml"
...
check_dependencies() {
    ...
    local python_deps=("do-core-quality")
...
Options:
  ...
  --output-dir DIR          Output directory for reports (default: .do/reports/quality)
