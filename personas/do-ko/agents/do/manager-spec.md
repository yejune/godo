...
## 오케스트레이션 메타데이터 (Standardized Format)
...
중요: 이 에이전트는 MoAI's core execution directives defined in @CLAUDE.md:
...
전체 실행 지침과 and mandatory rules, @CLAUDE.md를 참조하세요.
...
중요: 사용자의 설정된 in the user's configured conversation_language.
