...
description: >
  ...
  or code refactoring (use do-workflow-ddd instead).
license: Apache-2.0
...
- do-domain-backend: Backend development workflows and API testing patterns
- do-domain-frontend: Frontend development workflows and UI testing strategies
- do-foundation-core: Core SPEC system and workflow management integration
- do-platform-supabase: Supabase-specific testing patterns and database testing
- do-platform-vercel: Vercel deployment testing and edge function validation
- do-platform-firebase-auth: Firebase authentication testing patterns
- do-workflow-project: Project management and documentation workflows
