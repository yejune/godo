...
description: >
  ...
  Do NOT use for code quality validation (use do-foundation-quality instead)
  or implementation workflows (use do-workflow-ddd instead).
license: Apache-2.0
...
Skills:
- do-foundation-core: Integration with TRUST 5 and SPEC workflow
- do-workflow-spec: Assumption documentation in SPEC format
- do-domain-backend: Technology-specific trade-off criteria
- do-domain-frontend: UI/UX decision frameworks
