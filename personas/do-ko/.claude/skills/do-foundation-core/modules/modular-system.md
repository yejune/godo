...
decision = splitter.should_split(".claude/skills/do-foundation-core/SKILL.md")
...
if decision["split_needed"]:
 ...
 ".claude/skills/do-foundation-core",
...
# Usage
organizer = SkillOrganizer(".claude/skills/do-foundation-core")
...
with open(".claude/skills/do-foundation-core/NAVIGATION.md", 'w') as f:
 f.write(navigation)
```
...
# Usage
discovery = ModuleDiscovery(".claude/skills/do-foundation-core")
...
Skills:
- do-foundation-progressive-disclosure - Content structuring
- do-cc-skill-factory - Skill creation with modular structure
- do-foundation-token-optimization - File loading efficiency
...
- Skill("do-foundation-core") modules/ - Memory files following modular pattern
