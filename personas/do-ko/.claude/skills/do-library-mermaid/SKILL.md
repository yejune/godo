...
To invoke this skill, use the standard skill invocation pattern with the skill name do-library-mermaid.
...
Skills that complement this skill include do-docs-generation for comprehensive documentation generation, do-workflow-docs for diagram validation and documentation workflows, and do-library-nextra for architecture documentation sites.
