...
- MoAI-ADK Documentation: https://github.com/do-adk/docs
- Claude Code Skills Guide: https://docs.anthropic.com/claude-code/skills
- SPEC-First DDD Methodology: See `do-foundation-core/modules/spec-first-ddd.md`

### Related Skills

- do-foundation-core - Core execution patterns and SPEC workflow
