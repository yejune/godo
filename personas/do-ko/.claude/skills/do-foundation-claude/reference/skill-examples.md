...
- [`do-docs-toolkit`](../do-docs-toolkit/SKILL.md) - General documentation patterns
- [`do-domain-backend`](../do-domain-backend/SKILL.md) - Backend API expertise
- [`do-context7-integration`](../do-context7-integration/SKILL.md) - Latest framework docs
...
- [`do-lang-python`](../do-lang-python/SKILL.md) - Python-specific patterns
- [`do-code-quality`](../do-code-quality/SKILL.md) - General code quality assessment
- [`do-cc-claude-md`](../do-cc-claude-md/SKILL.md) - Documentation generation
...
- [`do-lang-python`](../do-lang-python/SKILL.md) - Python language patterns
- [`do-workflow-ddd`](../do-workflow-ddd/SKILL.md) - DDD methodology
- [`do-quality-gate`](../do-quality-gate/SKILL.md) - Quality validation
...
```yaml
---
name: do-modern-javascript-patterns
...
- [`do-domain-frontend`](../do-domain-frontend/SKILL.md) - Frontend development patterns
- [`do-context7-integration`](../do-context7-integration/SKILL.md) - Latest framework docs
- [`do-web-performance`](../do-web-performance/SKILL.md) - Performance optimization
...
```yaml
---
name: do-security-analysis-expert
...
- [`do-cc-security`](../do-cc-security/SKILL.md) - General security patterns
- [`do-quality-gate`](../do-quality-gate/SKILL.md) - Quality validation
- [`do-domain-backend`](../do-domain-backend/SKILL.md) - Backend security
...
```yaml
---
name: do-workflow-automation-expert
...
- [`do-devops-expert`](../do-devops-expert/SKILL.md) - DevOps best practices
- [`do-monitoring-expert`](../do-monitoring-expert/SKILL.md) - Monitoring strategies
- [`do-security-expert`](../do-security-expert/SKILL.md) - Security automation
