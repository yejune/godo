...
Purpose: Real-world usage examples and patterns for do-worktree skill integration with MoAI-ADK workflow.
...
cp .moai/worktrees/PROJECT/.do-worktree-registry.json .moai/worktrees/PROJECT/.do-worktree-registry.json.backup
