...
Skills:
- do-foundation-core - Parallel development patterns
- do-workflow-project - Project management integration
- do-workflow-spec - SPEC-driven development
- do-git-strategy - Git workflow optimization
