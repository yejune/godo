...
metadata:
  ...
  related-skills: "do-platform-supabase, do-platform-vercel, do-lang-typescript, do-domain-backend, do-expert-security"
...
- do-platform-supabase: Database with auth integration
- do-platform-vercel: Deployment with edge authentication
- do-lang-typescript: TypeScript patterns for auth SDKs
- do-domain-backend: Backend architecture with authentication
- do-domain-frontend: React/Next.js frontend integration
- do-expert-security: Security audit and threat modeling
