...
- `do-domain-backend` - REST API and microservices architecture
- `do-domain-database` - SQL patterns and query optimization
- `do-workflow-testing` - DDD and testing strategies
- `do-essentials-debug` - AI-powered debugging
- `do-platform-deploy` - Deployment and infrastructure
