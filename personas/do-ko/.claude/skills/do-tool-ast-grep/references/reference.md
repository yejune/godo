...
sg scan --config .claude/skills/do-tool-ast-grep/rules/sgconfig.yml
...
- **do-workflow-testing** - DDD integration, test pattern detection
- **do-foundation-quality** - TRUST 5 compliance, code quality gates
- **do-domain-backend** - API pattern detection, security scanning
