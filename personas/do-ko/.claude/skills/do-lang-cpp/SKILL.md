...
- `do-lang-rust` - Systems programming comparison and interop
- `do-domain-backend` - Backend service architecture
- `do-workflow-testing` - DDD and testing strategies
- `do-essentials-debug` - Debugging and profiling
- `do-foundation-quality` - TRUST 5 quality principles
