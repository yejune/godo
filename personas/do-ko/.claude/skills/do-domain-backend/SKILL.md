...
description: >
  ...
  (use do-domain-database instead) or frontend implementation
  (use do-domain-frontend instead).
license: Apache-2.0
...
- do-domain-frontend - Full-stack development integration
- do-domain-database - Advanced database patterns
- do-foundation-core - MCP server development patterns for backend services
- do-quality-security - Security validation and compliance
- do-foundation-core - Core architectural principles
