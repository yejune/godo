...
- `do-foundation-claude`: Claude Code authoring and configuration
- `do-foundation-core`: Core execution patterns and SPEC workflow
- `do-workflow-project`: Project management and documentation
- `do-cc-memory`: Memory management and persistence
