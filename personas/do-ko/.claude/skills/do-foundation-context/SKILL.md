...
description: >
  ...
  (use do-foundation-core instead).
license: Apache-2.0
...
- do-cc-memory - Memory management and context persistence
- do-cc-configuration - Session configuration and preferences
- do-core-workflow - Workflow state persistence and recovery
- do-cc-agents - Agent state management across sessions
