...
- do-lang-kotlin for Kotlin interoperability and Spring Kotlin extensions
- do-domain-backend for REST API, GraphQL, and microservices architecture
- do-domain-database for JPA, Hibernate, and R2DBC patterns
- do-foundation-quality for JUnit 5, Mockito, and TestContainers integration
- do-infra-docker for JVM container optimization
