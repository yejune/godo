...
description: >
  ...
  (use do-domain-frontend instead) or shadcn/ui specifics
  (use do-library-shadcn instead).
license: Apache-2.0
...
- do-lang-typescript - TypeScript and JavaScript best practices
- do-foundation-core - TRUST 5 quality validation
- do-library-nextra - Documentation generation
- do-library-shadcn - shadcn/ui specialized patterns
