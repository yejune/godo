...
metadata:
  ...
  related-skills: "do-domain-frontend, do-docs-generation"
...
- do-domain-frontend: React/Vue SVG component integration
- do-docs-generation: SVG diagram generation for documentation
- do-domain-uiux: Icon systems and design system integration
