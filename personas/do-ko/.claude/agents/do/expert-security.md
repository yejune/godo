...
skills: do-foundation-claude, do-foundation-core, do-foundation-quality, do-workflow-testing, do-platform-auth0, do-platform-clerk, do-platform-firebase-auth, do-tool-ast-grep
...
1. **AST-Grep Security Scan**: Use `sg scan --config .claude/skills/do-tool-ast-grep/rules/sgconfig.yml` to detect structural vulnerability patterns
...
Related Skills:
- do-platform-auth0: Auth0 security specialist (Attack Protection, MFA, Token Security, DPoP/mTLS, Compliance, SSO, SAML, OIDC)
- do-tool-ast-grep: AST-based security pattern scanning and automated fixes
