...
# Do Workflow Project - Integrated Project Management System
...
- do-foundation-core: Core execution patterns and SPEC-driven development workflows
- do-foundation-claude: Claude Code integration and configuration
- do-workflow-docs: Unified documentation management
- do-workflow-templates: Template optimization strategies
- do-library-nextra: Advanced documentation architecture
