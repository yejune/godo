...
The manager-quality agent executes: gh issue create --repo do-focus/do-focus
...
- Description content
- Priority level
- Environment information (Do version, OS)
...
- Phase 1 collects all user input at Do orchestrator level
...
- Phase 1: Do orchestrator (AskUserQuestion for feedback collection)
