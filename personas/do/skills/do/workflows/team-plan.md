...
- Triggered by: /do plan --team OR auto-detected complexity >= threshold

## Phase 0: Team Setup

1. Read configuration:
   - .do/config/sections/workflow.yaml for team settings
   - .do/config/sections/quality.yaml for development mode
...
SPEC output at: .do/specs/SPEC-XXX/spec.md
