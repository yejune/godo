...
description: >
  ...
  Do NOT use for writing tests (use do-workflow-testing instead)
...
- do-foundation-core - TRUST 5 framework reference
- do-workflow-ddd - DDD workflow validation
- do-security-owasp - Security compliance
- do-context7-integration - Context7 best practices
- do-performance-optimization - Performance analysis

Commands:

- /do:2-run - DDD validation integration
- /do:3-sync - Documentation quality checks
- /do:9-feedback - Quality improvement feedback
