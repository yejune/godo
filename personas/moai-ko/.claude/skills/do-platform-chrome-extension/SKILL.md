---
name: do-platform-chrome-extension
description: >
...
metadata:
  ...
  related-skills: "do-lang-typescript, do-lang-javascript, do-domain-frontend"
...
- do-lang-typescript for TypeScript patterns in extension development
- do-lang-javascript for JavaScript patterns and ES module usage
- do-domain-frontend for React or framework-based popup and side panel UI
- do-domain-backend for server-side API integration
- do-workflow-testing for extension testing strategies
