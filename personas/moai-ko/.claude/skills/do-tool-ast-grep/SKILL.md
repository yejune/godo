...
metadata:
  ...
  related-skills: "do-workflow-testing, do-foundation-quality, do-domain-backend, do-domain-frontend"
  context: "fork"
  agent: "Explore"
...
To scan with MoAI-ADK rules, execute sg scan with config pointing to .claude/skills/do-tool-ast-grep/rules/sgconfig.yml.
...
- do-workflow-testing: DDD integration and test pattern detection
- do-foundation-quality: TRUST 5 compliance and code quality gates
- do-domain-backend: API pattern detection and security scanning
- do-domain-frontend: React/Vue pattern optimization
- do-lang-python: Python-specific security and style rules
- do-lang-typescript: TypeScript type safety patterns
