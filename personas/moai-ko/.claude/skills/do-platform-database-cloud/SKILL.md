---
name: do-platform-database-cloud
description: >
...
metadata:
  ...
  related-skills: "do-platform-auth, do-lang-typescript, do-domain-backend"
...
# do-platform-database-cloud: Cloud Database Platform Specialist
...
- do-platform-auth for authentication integration with Supabase Auth or Firebase Auth
- do-lang-typescript for TypeScript patterns across all platforms
- do-lang-flutter for Firestore mobile SDK patterns
- do-domain-backend for backend architecture with database integration
- do-domain-mobile for mobile-first database patterns
- do-quality-security for security best practices (RLS policies, Security Rules)
