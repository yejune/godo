...
- Load do-tool-ast-grep skill for complex pattern matching
...
- do-foundation-claude: This authoring kit
- do-foundation-core: SPEC system and workflows
- do-foundation-philosopher: Strategic thinking
