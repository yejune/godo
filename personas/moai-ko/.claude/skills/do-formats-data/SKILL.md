...
- do-domain-backend - Backend data serialization and API responses
- do-domain-database - Database data format optimization
- do-foundation-core - MCP data serialization and transmission patterns
- do-workflow-docs - Documentation data formatting
- do-foundation-context - Context optimization for token budgets
