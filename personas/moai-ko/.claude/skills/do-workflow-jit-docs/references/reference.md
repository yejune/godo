# do-workflow-jit-docs Reference
...
- `do-docs-generation`: Generate documentation
- `do-workflow-docs`: Documentation workflows
- `do-library-nextra`: Nextra documentation sites
- `do-foundation-context`: Token budget management
