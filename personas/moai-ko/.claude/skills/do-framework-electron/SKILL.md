...
- do-lang-typescript - TypeScript patterns for type-safe Electron development
- do-domain-frontend - React, Vue, or Svelte renderer development
- do-lang-javascript - Node.js patterns for main process
- do-domain-backend - Backend API integration
- do-workflow-testing - Testing strategies for desktop apps
