...
- do-lang-java - JVM interoperability, Spring Boot integration
- do-domain-backend - REST API, GraphQL, microservices patterns
- do-domain-database - Doobie, Slick, database patterns
