...
Purpose: Integration patterns for do-worktree with development tools, IDEs, terminals, CI/CD pipelines, and monitoring systems.
...
- Sync Worktree: Run do-worktree sync command
...
- Command option completion for all do-worktree subcommands
...
Navigation Aliases:
- mw: Short alias for do-worktree
- mwl: List worktrees
