...
description: >
  ...
  Do NOT use for SPEC document creation (use do-workflow-spec instead)
...
- do-project-config-manager: Configuration management and validation
- do-cc-configuration: Claude Code settings integration
- do-foundation-specs: SPEC template generation
- do-docs-generation: Documentation template scaffolding
- do-core-workflow: Template-driven workflows
...
- v2.0.0 (2025-11-24): Unified do-core-code-templates, do-core-feedback-templates, and do-project-template-optimizer into single skill with 5 core patterns
