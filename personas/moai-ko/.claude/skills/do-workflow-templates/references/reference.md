# do-workflow-templates Reference
...
- Template storage: `.claude/skills/do-workflow-templates/templates/`
- Backups: `.moai/backups/templates/`
- Merge conflicts: `.moai/merge-conflicts/`
- Version history: `.moai/config/template-versions.json`
- Feedback templates: `.claude/skills/do-workflow-templates/modules/feedback-templates.md`
...
- do-workflow-project - Project initialization with templates
- do-foundation-core - SPEC-driven template generation
