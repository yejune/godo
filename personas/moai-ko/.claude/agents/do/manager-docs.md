...
skills: do-foundation-claude, do-foundation-core, do-docs-generation, do-workflow-jit-docs, do-workflow-templates, do-library-mermaid, do-library-nextra, do-formats-data, do-foundation-context
hooks:
  PostToolUse:
    - matcher: "Write|Edit"
      hooks:
...
- do-foundation-core: SPEC-first DDD, TRUST 5 framework, execution rules
- do-workflow-docs: Documentation workflow, validation scripts
- do-library-mermaid: Mermaid diagram creation and validation
- do-foundation-claude: Claude Code authoring patterns, skills/agents/commands
- do-library-nextra: Nextra framework setup and optimization

# Conditional skills (auto-loaded by MoAI when needed)

conditional_skills = [
"do-domain-uiux", # WCAG compliance, accessibility patterns, Pencil MCP integration
"do-lang-python", # Python documentation patterns
"do-lang-typescript", # TypeScript documentation patterns
"do-workflow-project", # Project documentation management
"do-ai-nano-banana" # AI content generation
]
