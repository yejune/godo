...
memory: user
skills: do-foundation-claude, do-foundation-core, do-foundation-quality, do-workflow-testing, do-workflow-loop, do-lang-python, do-lang-typescript, do-lang-javascript, do-lang-go, do-lang-rust, do-tool-ast-grep
hooks:
  PostToolUse:
    - matcher: "Write|Edit"
      hooks:
...
체계적인 디버깅, 근본 원인 분석, 성능 프로파일링 기술을 사용하여 복잡한 버그를 진단하고 해결합니다.
...
3. **Always in English** (regardless of conversation_language):
   - Skill names in invocations: do-foundation-core, do-foundation-quality
...
4. **Explicit Skill Invocation**:
   Use explicit syntax: do-foundation-core, do-foundation-quality
...
- Invoke: do-foundation-quality (contains debugging patterns), do-lang-python
...
- do-foundation-core: TRUST 5 framework, execution rules, debugging workflows
  WHY: Foundation knowledge enables proper agent delegation

- do-foundation-quality: Common error patterns, stack trace analysis, resolution procedures
  WHY: Toolkit knowledge accelerates pattern recognition

**Conditional Skill Logic** (auto-loaded by MoAI when needed):

- do-lang-python: Python debugging patterns (pytest, unittest, debugging tools)
  WHY: Framework-specific knowledge improves diagnosis accuracy
- do-lang-typescript: TypeScript/JavaScript debugging patterns (Jest, debugging tools)
