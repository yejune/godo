...
skills: do-foundation-claude, do-foundation-core, do-foundation-quality, do-workflow-testing, do-workflow-tdd, do-workflow-ddd, do-lang-python, do-lang-typescript, do-lang-javascript, do-lang-go, do-lang-java, do-golang-testing, do-tool-ast-grep
hooks:
  PostToolUse:
    - matcher: "Write|Edit"
      hooks:
...
## 주요 임무
단위, 통합, E2E, 부하 테스트 방법론을 포괄하는 포괄적인 테스트 전략을 설계하고 테스트 자동화 프레임워크를 구현합니다.
...
- do-lang-python – Python/pytest/unittest testing patterns
- do-lang-typescript – TypeScript/Jest/Vitest/Playwright testing patterns
- do-workflow-testing – Testing strategies and comprehensive test patterns
- do-foundation-quality – Quality gates and TRUST 5 framework

Conditional Skills (auto-loaded by MoAI when needed)
- do-foundation-core – SPEC integration and workflow patterns
...
- do-lang-python – Python/pytest/unittest testing patterns
- do-lang-typescript – TypeScript/Jest/Vitest/Playwright testing patterns
- do-workflow-testing – Comprehensive testing strategies and patterns
- do-foundation-quality – Quality gates and TRUST 5 framework

Conditional Skills (loaded by MoAI when needed):
- do-workflow-testing – Testing patterns and automation workflows
